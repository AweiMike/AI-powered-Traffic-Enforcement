...
MANUAL_DUI_CRASH_CASES = [
    {
        "case_id": "11504ACC91B3116",
        "occurred": "2026-04-26 17:08",
        "location": "新化區豐榮里大智路145巷",
        "severity": "A2",
        "note": "EIS 飲酒情形(32.) 與 肇因(34.) 皆空白，自動偵測無法判定；"
                "「新化分局115年酒後駕車交通事故及取締件數.xlsx」清冊確認為酒駕。",
        "verified_by": "新化分局115年酒後駕車交通事故清冊",
    },
    # 未來需要新增時，在此加入新項目（請依時間倒序）
    # 範例：
    # {
    #     "case_id": "...",
