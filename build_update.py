...
def create_changelog():
    ...
    - 進一步發現：同仁將「攔舉-肇事」勾選為「攔舉-一般」造成黑數
    - 採 UNION 雙信號修復：subtype 攔舉-肇事 OR violation_name 含
      「肇事/致人/重傷/致死/致傷/死亡」等加重情節關鍵字
    - violation_name 是法條結構化資料、不能竄改，是抓黑數的可靠來源
    - 實測比舊版多抓 ~44% 真實酒駕肇事案件
